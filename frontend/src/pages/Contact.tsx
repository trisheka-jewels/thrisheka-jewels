...
const contactInfo = [
  ...
  },
  {
    ...
    details: [
      "Ramanjinaya Nagar",
      "Behind Indian Bank, Belgal Cross",
      "Ballari, Karnataka",
    ],
  },
  {
...
export default function Contact() {
  const handleWhatsApp = () => {
    window.open(
      "https://wa.me/917794941645?text=Hi! I am interested in Thrisheka Jewels.",
      "_blank"
    );
  };
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-muted-foreground mb-6 max-w-xl mx-auto">
              Chat with us directly on WhatsApp for quick responses, order
              updates, and personalized jewellery recommendations.
            </p>
            <Button
              size="lg"
              onClick={handleWhatsApp}
          ...
          <div className="aspect-[16/9] md:aspect-[21/9] bg-muted rounded-2xl overflow-hidden">
            <div className="w-full h-full flex items-center justify-center text-muted-foreground">
              <div className="text-center">
                ...
                <p>Map coming soon</p>
                <p className="text-sm">
                  Ramanjinaya Nagar, Ballari, Karnataka
                </p>
              </div>
            </div>
          </div>
